  ...
  if (e.key === 'Tab'){
    if (y === -1){
      ...
      if(result.includes("cd g")){
        input.value = "cd Joseph\\ Boyadjian/";
      } 
  ...
  if(e.key === 'Enter'){
    if(result === ""){
      ...
      if (y === -1){
        ...
        if(result === "joseph Boyadjian" || result === "cd joseph Boyadjian" || result === "cd joseph\\ Boyadjian/" || result === "joseph\\ Boyadjian/" || result === "cd"){
          y ++;
      ...
      if (y === -1){
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">joseph Boyadjian:~$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`);
      } else if (y === 1){
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">joseph Boyadjian:~/portfolio/themes$:</p><input type="text" autofocus class="input themeinput" id="input${i}" tabindex="-1">`);
      } else {
        terminal = document.getElementById("terminal");
        terminal.insertAdjacentHTML("beforeend", `<p class="commande" id="answer${i}">joseph Boyadjian:~/portfolio$</p><input type="text" autofocus class="input" id="input${i}" tabindex="-1">`);
      }
      document.getElementById(`input${i}`).focus();
